...
第三期已于 2026-07-18 通过发布门槛：Runtime 177 项、Renderer 15 项、Main/sidecar 15 项全部通过；production build、原生 MCP Seatbelt 权限矩阵、官方 SDK fixture、进程组子进程清理、超时/取消/崩溃注入和重启读取均通过。
