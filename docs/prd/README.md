...
第一期实现以 [MVP Lite](../mvp-lite.md) 为准。第二期以 [第二期实施范围清单](../mvp-phase-2.md) 为准：本期先交付可排队、可暂停、可恢复核验、可审计的 Runtime 基础，不把完整目标态一次性并入。本目录保留完整目标态产品范围与后续加固要求。
