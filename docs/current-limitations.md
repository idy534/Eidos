...
- Git Project 可以创建 Local 或 Worktree Execution Session。Managed Worktree 默认是 detached HEAD。Git staging、commit、push、pull、merge 和 rebase UI 尚未实现。
