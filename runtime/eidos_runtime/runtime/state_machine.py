...
TRANSITIONS: dict[type[StrEnum], dict[StrEnum, frozenset[StrEnum]]] = {
    RunStatus: {
        ...
        RunStatus.RUNNING: frozenset({
            RunStatus.WAITING_APPROVAL, RunStatus.WAITING_INPUT, RunStatus.WAITING_AGENTS, RunStatus.FINALIZING, RunStatus.SUCCEEDED, RunStatus.FAILED,
            RunStatus.CANCELED, RunStatus.INTERRUPTED, RunStatus.QUEUED,
        }),
        RunStatus.WAITING_AGENTS: frozenset({RunStatus.QUEUED, RunStatus.CANCELED, RunStatus.FAILED, RunStatus.INTERRUPTED}),
