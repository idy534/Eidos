...
export const IPC = {
  ...
  WORKSPACE_PREVIEW_URL: "workspace:preview-url",
  WORKSPACE_RELEASE_PREVIEW: "workspace:release-preview",
  ...
  SESSION_GIT_READ_PATCH: "session:git-read-patch",
  SESSION_GIT_APPLY_HUNK: "session:git-apply-hunk",
