...
const RUNTIME_ERROR_MESSAGES: Record<string, string> = {
  ...
  WORKTREE_RESTORE_REQUIRED: "受管工作树需要恢复。请先恢复工作树，再更改执行环境。",
  HANDOFF_NOT_SUPPORTED: "当前任务不支持更改执行环境。",
  HANDOFF_SOURCE_CHANGED: "当前执行环境已经发生变化。请刷新后重试。",
  HANDOFF_TARGET_CHANGED: "目标执行环境已经发生变化。请刷新后重试。",
  HANDOFF_LOCAL_CONFLICT: "当前工作树的修改无法安全同步到本地工作区。请先处理本地冲突。",
  HANDOFF_GIT_CONFLICT: "当前版本状态存在冲突，无法安全更改执行环境。",
